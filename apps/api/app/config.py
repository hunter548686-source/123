...
class Settings(BaseSettings):
    ...
    vast_ai_submit_path: str = "/asks/{offer_id}/"
    vast_ai_status_path_template: str = "/instances/{external_task_id}/"
    vast_ai_cancel_path_template: str = "/instances/{external_task_id}/"
    vast_ai_result_path_template: str = "/instances/{external_task_id}/"
    vast_ai_cleanup_path_template: str = "/instances/{external_task_id}/"
    ...
    runpod_offers_path: str = "/gpu-types"
    runpod_submit_path: str = "/pods"
    runpod_status_path_template: str = "/pods/{external_task_id}"
    runpod_cancel_path_template: str = "/pods/{external_task_id}/stop"
    runpod_result_path_template: str = "/pods/{external_task_id}"
    runpod_cleanup_path_template: str = "/pods/{external_task_id}"
    provider_ready_state_is_success: bool = True
