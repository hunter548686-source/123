...
RUNPOD_GRAPHQL_URL="${STABLEGPU_RUNPOD_GRAPHQL_URL:-https://api.runpod.io/graphql}"
...
upsert_env "STABLEGPU_VAST_AI_SUBMIT_PATH" "/asks/{offer_id}/"
upsert_env "STABLEGPU_VAST_AI_STATUS_PATH_TEMPLATE" "/instances/{external_task_id}/"
upsert_env "STABLEGPU_VAST_AI_CANCEL_PATH_TEMPLATE" "/instances/{external_task_id}/"
upsert_env "STABLEGPU_VAST_AI_RESULT_PATH_TEMPLATE" "/instances/{external_task_id}/"
upsert_env "STABLEGPU_VAST_AI_CLEANUP_PATH_TEMPLATE" "/instances/{external_task_id}/"
upsert_env "STABLEGPU_VAST_AI_API_KEY" "${VAST_KEY}"
upsert_env "STABLEGPU_RUNPOD_BASE_URL" "${RUNPOD_BASE_URL}"
upsert_env "STABLEGPU_RUNPOD_GRAPHQL_URL" "${RUNPOD_GRAPHQL_URL}"
upsert_env "STABLEGPU_RUNPOD_OFFERS_PATH" "/gpu-types"
upsert_env "STABLEGPU_RUNPOD_SUBMIT_PATH" "/pods"
upsert_env "STABLEGPU_RUNPOD_STATUS_PATH_TEMPLATE" "/pods/{external_task_id}"
upsert_env "STABLEGPU_RUNPOD_CANCEL_PATH_TEMPLATE" "/pods/{external_task_id}/stop"
upsert_env "STABLEGPU_RUNPOD_RESULT_PATH_TEMPLATE" "/pods/{external_task_id}"
upsert_env "STABLEGPU_RUNPOD_CLEANUP_PATH_TEMPLATE" "/pods/{external_task_id}"
upsert_env "STABLEGPU_RUNPOD_API_KEY" "${RUNPOD_KEY}"
upsert_env "STABLEGPU_PROVIDER_READY_STATE_IS_SUCCESS" "true"
